...
import type { Product, Opportunity, Account, Contact } from '@/types';
...
export default function NewQuotePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [productsRes, opportunitiesRes, accountsRes, contactsRes] = await Promise.all([
  ...
  const onSubmit = async (data: QuoteFormData) => {
    ...
    try {
      ...
      toast(error.response?.data?.message || 'Failed to create quote', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      <PageHeader title="New Quote" description="Create a new quote" />
