...
<head>
  ...
  <title>@yield('title', 'Support Portal') — NavCRM</title>
...
<body style="background:var(--bg-main,#f8fafc); min-height:100vh;">
  ...
  <header class="portal-header d-flex align-items-center justify-content-between">
    <a href="{{ route('portal.dashboard') }}" class="portal-brand">
      Nav<span>CRM</span>
      <span style="color:rgba(255,255,255,.5);font-weight:400;margin-left:.5rem;">Support Portal</span>
    </a>
    <div class="d-flex align-items-center gap-3">
      @if(session('portal_contact_id'))
        <a href="{{ route('portal.tickets.index') }}" class="portal-nav-link">
  ...
  <footer class="portal-footer text-center py-3" style="color:var(--text-muted);font-size:.8rem;">
    Powered by NavCRM &mdash; Customer Support Portal
  </footer>
